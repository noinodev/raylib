...
void DrawMeshInstanced(Mesh mesh, Material material, const Matrix *transforms, int instances)
{
    ...
    static unsigned int instancesVboId = 0;
    ...
    // The API may benefit from a persistent VBO for matrix transforms

    // Memory layout for float16 and Matrix types is identical
    // Remove malloc() and copy in hot path, replaced with zero-copy pointer cast
